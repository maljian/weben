...
$pdf->Cell(50, 10, "",0, 1);
$pdf->Cell(50, 4, utf8_decode($data['institution']),0, 1);
$pdf->Cell(50, 4, utf8_decode($data['partner']),0, 1);
$pdf->Cell(50, 4, utf8_decode($data['street']),0, 1);
$pdf->Cell(50, 4, $data['postalcode']." ".utf8_decode($data['city']),0, 1);
$pdf->Cell(50, 10, "",0, 1);
$pdf->Cell(190, 4, "","T", 1);
...
$pdf->Cell(50, 10, "",0, 1);
$pdf->SetFont('Arial', '', 11);
$pdf->Cell(100, 4, "Sehr geehrte/r Frau/Herr ".utf8_decode($data['partner']),0,1);
$pdf->Cell(50, 4, "",0, 1);
